package com.tasks.task1.students.util;


import com.tasks.task1.students.data.Student;
import com.tasks.task1.students.data.StudentFee;
import com.tasks.task1.students.data.StudentMarks;
import com.tasks.task1.students.data.Subject;
...
public class StudentsService {
    ...
    public void method() {
        ...
        { // TASK 1  Print student rno, name, branch, year
            ...
            System.out.print("\nRollNo :");
            student1.setRno("15691a03d4"/*scanner.nextLine()*/);
            System.out.print("      Name :");
            student1.setName("Rudhreswar"/*scanner.nextLine()*/);
            System.out.print("      Branch :");
            student1.setBranch("Mechanical"/*scanner.nextLine()*/);
            System.out.print("      Year  :");
            student1.setYear(1/*Integer.parseInt(scanner.nextLine())*/);
            ...
            System.out.print("\nRollNo :");
            student2.setRno("15691a0305"/*scanner.nextLine()*/);
            System.out.print("       Name :");
            student2.setName("Anand"/*scanner.nextLine()*/);
            System.out.print("       Branch :");
            student2.setBranch("Mechanical"/*scanner.nextLine()*/);
            System.out.print("       Year  :");
            student2.setYear(1/*Integer.parseInt(scanner.nextLine())*/);
            ...
            System.out.print("\nRollNo :");
            student3.setRno("15691a03d5"/*scanner.nextLine()*/);
            System.out.print("      Name :");
            student3.setName("Ruhulla"/*scanner.nextLine()*/);
            System.out.print("      Branch :");
            student3.setBranch("Mechanical"/*scanner.nextLine()*/);
            System.out.print("       Year  :");
            student3.setYear(1/*Integer.parseInt(scanner.nextLine())*/);
            ...
            System.out.print("\nRollNo :");
            student4.setRno("15691a03d4"/*scanner.nextLine()*/);
            System.out.print("         Name :");
            student4.setName("YuvaSree"/*scanner.nextLine()*/);
            System.out.print("         Branch :");
            student4.setBranch("Mechanical"/*scanner.nextLine()*/);
            System.out.print("         Year  :");
            student4.setYear(2/*Integer.parseInt(scanner.nextLine())*/);
            ...
            studentFee.setAmount(654465/*Double.parseDouble(scanner.nextLine())*/);
            System.out.println("Enter the Date of fee Paid");
            studentFee.setDate("date"/*scanner.nextLine()*/);
...
// Subject Details i.e Task 3
            // Task 3 Print All Students rno, name, subject name, marks
            {
                ...
                sub1.setSubjectName("sub1 "/*scanner.nextLine()*/);
                System.out.println("Enter Number of Subject  :");
                sub1.setSubjectsNo("sub2"/*scanner.nextLine()*/);

                Subject sub2 = new Subject();
                sub2.setStudentListSub(list_students);
                System.out.println("Enter name of Subject2 :");
                sub2.setSubjectName("sub2"/*scanner.nextLine()*/);
                System.out.println("Enter Number of Subject  :");
                sub2.setSubjectsNo("2"/*scanner.nextLine()*/);

                Subject sub3 = new Subject();
                sub3.setStudentListSub(list_students);
                System.out.println("Enter name of Subject3 :");
                sub3.setSubjectName("sub3"/*scanner.nextLine()*/);
                System.out.println("Enter Number of Subject  :");
                sub3.setSubjectsNo("sub3"/*scanner.nextLine()*/);

                Subject sub4 = new Subject();
                sub4.setStudentListSub(list_students);
                System.out.println("Enter name of Subject4 :");
                sub4.setSubjectName("sub4"/*scanner.nextLine()*/);
                System.out.println("Enter Number of Subject  :");
                sub4.setSubjectsNo("sub4"/*scanner.nextLine()*/);
                ...
                studentMarks1.setMarks(123/*Integer.parseInt(scanner.nextLine())*/);

                StudentMarks studentMarks2 = new StudentMarks();

                System.out.println("Enter Subject2 Marks :");
                studentMarks2.setListStudentMarks(list_subjects);
                studentMarks2.setMarks(431/*Integer.parseInt(scanner.nextLine())*/);
                ...
                studentMarks3.setMarks(432/*Integer.parseInt(scanner.nextLine())*/);

                StudentMarks studentMarks4 = new StudentMarks();

                System.out.println("Enter Subject3 Marks :");
                studentMarks4.setListStudentMarks(list_subjects);
                studentMarks4.setMarks(432122/*Integer.parseInt(scanner.nextLine())*/);
                ...
                for (Student student : list_students
                    ...
                    if (student.getYear() == 1) {
                        System.out.println("\n Roll No : " + student.getRno() + ", Name Of Student : " + student.getName() + ", Branch : " + student.getBranch() + ", year : " + student.getYear());
                    }
                }
    ...
    public static void main(String[] args) {
        StudentsService printDetails = new StudentsService();
        printDetails.method();
